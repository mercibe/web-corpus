...
public class ContexteSetTest {
	...
	public void cooccurrentTest() {
		Corpus corpus = new Corpus("Corpus de test",
				"Un nouveau corpus de test");
		corpus.setDossierData(System.getProperty("java.io.tmpdir")
		...
		Map<Position, List<InfoCooccurrent>>  infoCooccurrents = contextesSet
				.getInfoCooccurrents();
