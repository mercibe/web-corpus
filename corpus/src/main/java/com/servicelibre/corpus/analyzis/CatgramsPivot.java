...
public class CatgramsPivot extends CatgramsManager {
	...
	{
	    // Mots grammaticaux
		catgrams.put("CONJONCTION", new Catgram("CONJONCTION", "conjonction", "conjonction", true, "conj."));
		...
		catgrams.put("DÉTERMINANT", new Catgram("DÉTERMINANT", "déterminant", "determinant", true, "dét."));
		...
		catgrams.put("ARTICLE", new Catgram("ARTICLE", "article", "article", true, "art."));
		...
		catgrams.put("PRONOM", new Catgram("PRONOM", "pronom", "pronom", true, "pr."));
		...
		catgrams.put("NOM_PROPRE", new Catgram("NOM_PROPRE", "nom propre", "propernoun", false, "n. pr.")); // 462+
		catgrams.put("SIGLE", new Catgram("SIGLE", "sigle", "sigle", false));
		catgrams.put("VERBE", new Catgram("VERBE", "verbe", "verb", false, "v."));
