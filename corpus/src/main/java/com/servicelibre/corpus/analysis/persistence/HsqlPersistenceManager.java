...
public class HsqlPersistenceManager extends JDBCPersitenceManager
{

    @Override
    protected void setDatabaseOptions()
    {
        super.setDatabaseOptions();
        
        jdbcTemplate.execute("SET DATABASE COLLATION \"French\"");
        jdbcTemplate.execute("SET IGNORECASE TRUE");        
    }
    ...
    protected void closeDatabase()
    {
        ...
        // Pour s'assurer de la persistence de HSQLDB
    ...
    protected void createTable(String tableName) throws SQLException
    {
        ...
        else if (tableName.equalsIgnoreCase(getTableNameWithPrefix(DOCUMENT_TABLENAME)))
        {
            ...
            this.jdbcTemplate.execute("CREATE TABLE " + documentTableName + "( doc_id varchar(255) PRIMARY KEY,"
                    + "titre LONGVARCHAR NOT NULL," + "categorie varchar(255) DEFAULT NULL," + "chapitre LONGVARCHAR,"
        ...
        else if (tableName.equalsIgnoreCase(getTableNameWithPrefix(MOT_TABLENAME)))
        {
            ...
            this.jdbcTemplate.execute("CREATE TABLE " + motTableName + "( doc_id VARCHAR(255),"
                    ...
                    + " FOREIGN KEY (doc_id) REFERENCES " + getTableNameWithPrefix(DOCUMENT_TABLENAME) + " (doc_id))");
