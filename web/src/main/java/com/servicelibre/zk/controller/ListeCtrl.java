...
public class ListeCtrl extends CorpusCtrl {
	...
	String prononc = getCible().equals("p") ? " la prononciation" : "";
	...
	motsGrid.setModel(new ListModelList(exécuterRecherche(recherche, false)));
	...
	ListModelList modelList = new ListModelList(exécuterRecherche(getRecherche(), ajouterHistorique));
